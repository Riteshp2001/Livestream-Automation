...
from lib.livestream import validate_authenticated_channel
...
def setup_youtube_token(force_reauth=False):
    ...
    validate_authenticated_channel(youtube, os.getenv('YOUTUBE_CHANNEL_ID'))
...
def main():
    ...
    force_reauth = '--force-youtube-auth' in sys.argv or os.getenv('FORCE_YOUTUBE_AUTH') == '1'
    ...
    setup_youtube_token(force_reauth=force_reauth)
